...
class GeneralTests(TestCase):
    def test_serving_static_files(self):
        ...
        result = finders.find('images/Yohann.jpg')
...
class IndexPageTests(TestCase):
    ...
    def test_index_using_template(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertTemplateUsed(response, 'Yohann/index.html')

    def test_rango_picture_displayed(self):
        # Check if is there an image called 'rango.jpg' on the index page
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/images/Yohann.jpg', response.content)
...
class AboutPageTests(TestCase):
    ...
    def test_about_using_template(self):
        ...
        self.assertTemplateUsed(response, 'Yohann/about.html')
...
class ModelTests(TestCase):
    ...
    def setUp(self):
        try:
            from populate_Yohann import populate
            populate()
        except ImportError:
